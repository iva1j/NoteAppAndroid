...
public class NoteanotActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_note_enter);
    ...
    private void actionDelete() {
        //ask user if they really want to delete the note!
        AlertDialog.Builder dialogDelete = new AlertDialog.Builder(this);
        dialogDelete.setMessage("Are you sure you want to delete?");
        dialogDelete.setTitle("delete note");
                ...
                switch (which) {
                    case DialogInterface.BUTTON_POSITIVE:
                        ...
                        if(mLoadedNote != null && Utilities.deleteFile(getApplicationContext(), mFileName)) {
                            Toast.makeText(NoteanotActivity.this, mLoadedNote.getTitle() + " is deleted"
                                    , Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(NoteanotActivity.this, "can not delete the note '" + mLoadedNote.getTitle() + "'"
                                    , Toast.LENGTH_SHORT).show();
                        }
                        finish();
                        break;
        ...
        alertDialog.setButton(DialogInterface.BUTTON_POSITIVE, "delete", listener);
    ...
    private void actionCancel() {
        ...
        if (!checkNoteAltred()) { //if note is not altered by user (user only viewed the note/or did not write anything)
            ...
            dialogCancel.setMessage("Do you want to save changes to this note?");
            dialogCancel.setTitle("Keep changes");
            AlertDialog alertDialog = dialogCancel.create();
            DialogInterface.OnClickListener listener = new DialogInterface.OnClickListener() {
    ...
    private void validateAndSaveNote() {
        ...
        if(content.isEmpty() && title.isEmpty()) { //title and content
            Toast.makeText(NoteanotActivity.this, "please enter some content!"
                    , Toast.LENGTH_SHORT).show();
            return;
        }
